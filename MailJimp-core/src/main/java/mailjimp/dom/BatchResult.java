...
public class BatchResult implements Serializable {
  ...
  public String toString() {
    ...
    builder.append("BatchResult{").append("addCount=").append(addCount).append(", successCount=").append(successCount).append(", updateCount=").append(updateCount).append(", errorCount=").append(errorCount).append(", errors=[");
    if (null != errors) {
