...
public class TestMailChimpParser {
  ...
  public static class SimpleValues implements IParsableProperty {
    ...
    // Watch out! The parameter is an Integer not an int. tThanks to auto boxing
  ...
  @SuppressWarnings("serial")
  static class MapWithHintsHas extends MappedValues implements IHasParserHints {
  ...
  private Map<String, Object> createSimpleValuesMap(final int id) {
    ...
    simpleValuesMap.put("my_string", "mailjimp" + id);
  ...
  private void assertSimpleValues(SimpleValues sv, final int expectedId) {
    ...
    assertEquals("mailjimp" + expectedId, sv.getMyString());
  }
  ...
  public void setVarsWrappedObjectArray() throws Exception {
    ...
    Object[] array = new Object[] { createSimpleValuesMap(42), createSimpleValuesMap(23), createSimpleValuesMap(5) };
